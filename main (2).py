...
class BankAccount:
  ...
  def withdrew(self, amount):
    if amount > 0 and amount <= self.__account_balance:
      self.__account_balance -= amount
      # self.__account_balance = self.__account_balance-amount
      print("Withdrew ₹{}. New balace: ₹{}".format(amount,self.__account_balance))
    else:
...
account = BankAccount(account_number="123456789",account_holder_name="M.Aarthi",initial_balance=5000.0)
